          ...
          <div className='all-screen' >
            <div className='mypageHeader' >
              <div style={{position:'relative', height:'100%'}}>
                ...
                <div className='mypageheadertxt'>친구 목록<img src='/img/arrow-left.png' onClick={()=>navigate("/mypage/"+userEmail)} className='mypageHeaderimg' style={{width:'26.26px', height:'24px'}}></img></div>
            </div>
          </div>
