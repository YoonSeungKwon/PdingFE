      ...
      <div className='all-screen' style={{position: 'relative'}}>
        <div className='mypageProfile' style={{textAlign:'center', alignItems:'center', backgroundColor:'#f5f5f5', justifyContent:'center'}}>
          <div style={{paddingTop:'3vh'}}>
            ...
            <div>
              <button style={{paddingBottom:'2vh'}} className='mypageWriteButton'onClick={()=>navigate("/write")}>
                  <img src='/img/edit.png' style={{width:'2vh'}}></img>
              </button>
            </div>
          </div>
          <div style={{whiteSpace:'nowrap',fontWeight:'500', fontSize:'20px', fontFamily:'pretendard-regular', paddingTop:'1.5vh'}}>{userName}</div>
          <div style={{fontSize:'16px', fontWeight:'400', color:'#7b7b7b',fontFamily:'pretendard-regular', marginBottom:'3vh'}}>{userEmail}</div>
        </div>
      
        <div className='mypageMenu' style={{marginTop:'3vh'}}>
